...
public class selecetfavorite  extends AppCompatActivity  {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_selecetfavorite);
//            getSupportActionBar().hide();
        ...
        private void setButtonClickListeners() {
            ...
            nextBtn.setOnClickListener(view -> {
                Intent intent = new Intent(selecetfavorite.this, browse.class);
